...
#include <math.h>
#include "stm32f1xx_hal.h"			// <-- choose the hal lib appropriate for your device



#define TXRX_PORT	GPIOA					// <-- select the 1-wire signal line port (GPIOA or GPIOB or ...)
#define TXRX_PIN	GPIO_PIN_8		// <-- select the 1-wire signal line pin (GPIO_PIN_1 or GPIO_PIN_2 or ...)
